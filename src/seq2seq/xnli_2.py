...
pairs = open('sent_prop_pairs_2.txt').readlines()
...
batched_seqs = [seqs[i:i+16] for i in range(0, len(seqs), 16)]
...
with open('entailments/entailments_2.tsv', 'w', encoding='utf-8') as f:
