...
pairs = open('/home2/aditya_hari/gsoc/rdf-to-text/scraping/notebooks/sent_prop_pairs/sent_prop_pairs_1.txt').readlines()
...
with open('entailments/entailments_1.tsv', 'w', encoding='utf-8') as f:
