...
neg_pairs = [i.split('\t') for i in open('/home2/aditya_hari/gsoc/rdf-to-text/src/seq2seq/negative_pairs.txt', 'r').readlines()]
pos_pairs = [i.split('\t') for i in open('/home2/aditya_hari/gsoc/rdf-to-text/src/seq2seq/positive_pairs.txt', 'r').readlines()]
